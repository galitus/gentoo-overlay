...
ZPUSH_RELEASE="final"
ZPUSH_BASE_VERSION="2.4"
ZPUSH_VERSION="2.4.3"
ZPUSH_BUILD=""
ZPUSH_SUFFIX=""

#SRC_URI="http://download.z-push.org/${ZPUSH_RELEASE}/${ZPUSH_BASE_VERSION}/z-push-${ZPUSH_VERSION}${ZPUSH_SUFFIX}${ZPUSH_BUILD}.tar.gz"
SRC_URI="https://stash.z-hub.io/rest/api/latest/projects/ZP/repos/z-push/archive?at=refs%2Fheads%2Fmaster&prefix=z-push&format=tar.gz -> ${P}.tar.gz"
S="${WORKDIR}/z-push"
