...
PATCHES=(
	...
	"${FILESDIR}"/${P}-fix-python-dir.patch
)
...
#	S=${S2}
	pushd ${WORKDIR}
	eapply "${FILESDIR}"/opencv-4.1.2-fix-nvidia-opticalflow-dep-for-cuda.patch
	popd
#	EAPPLY_OPTS=""
...
#	echo $(python_get_sitedir) > /tmp/pydir.txt
}
