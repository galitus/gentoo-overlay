...
DESCRIPTION="Quantities package for the python programming language"
HOMEPAGE="https://github.com/python-quantities/python-quantities"
SRC_URI="https://github.com/python-quantities/python-quantities/archive/v0.12.4.tar.gz -> quantities-0.12.4.tar.gz"
