...
SRC_URI="
	amd64? ( http://wdl1.pcfg.cache.wpscdn.com/wpsdl/wpsoffice/download/linux/${MY_PV}/${PN}_${PV}.XA_amd64.deb )
"
...
src_install() {
	...
	fperms 0755 /opt/kingsoft/wps-office/office6/{wps,wpp,et,promecefpluginhost}
}
